...
def P_Net(
    ...
    with slim.arg_scope([slim.conv2d],
        ...
        landmark_pred = slim.conv2d(
            net, num_outputs=10, kernel_size=[
                1, 1], stride=1, scope='conv4_3', activation_fn=None)
        ...
        if training:
            ...
            # batch*10
            landmark_pred = tf.squeeze(
                landmark_pred, [
                    1, 2], name="landmark_pred")
...
def R_Net(
    ...
    with slim.arg_scope([slim.conv2d],
        ...
        bbox_pred = slim.fully_connected(
            fc1, num_outputs=4, scope="bbox_fc", activation_fn=None)
        print bbox_pred.get_shape()
        # batch*10
